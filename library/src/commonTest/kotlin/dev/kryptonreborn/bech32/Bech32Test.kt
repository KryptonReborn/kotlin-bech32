...
class Bech32Test {
    ...
    private val VALID_BECH32M: Array<String> = arrayOf(
        "A1LQFN3A",
        "a1lqfn3a",
    ...
    private val INVALID_BECH32: Array<String> = arrayOf(
        " 1nwldj5",  // HRP character out of range
        charArrayOf(0x7f.toChar()).concatToString() + "1axkwrx",  // HRP character out of range
        charArrayOf(0x80.toChar()).concatToString() + "1eym55h",  // HRP character out of range
        ...
        "de1lg7wt" + charArrayOf(0xff.toChar()).concatToString(),  // Invalid character in checksum
        "A1G7SGD8",  // checksum calculated with uppercase form of HRP
        "10a06t8",  // empty HRP
        "1qzzfhee",  // empty HRP
    )

    private val INVALID_BECH32M: Array<String> = arrayOf(
        " 1xj0phk",  // HRP character out of range
        charArrayOf(0x7f.toChar()).concatToString() + "1g6xzxy",  // HRP character out of range
        charArrayOf(0x80.toChar()).concatToString() + "1vctc34",  // HRP character out of range
    ...
    private fun nip19Vectors() = listOf(
        Triple(
